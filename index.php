...
<head>
    ...
    <title>Sistem Pakar | Penyakit Kacang Hijau</title>
...
<div id="art-main">
    ...
    <div class="art-header-inner">
        ...
        <div class="art-logo">
                 <h1 class="art-logo-name"><a href="./index.php?top=home.php">SISTEM PAKAR DIAGNOSA <br>PENYAKIT KACANG HIJAU</a></h1>
                 <!-- <h2 class="art-logo-text">Menggunakan Metode Theorema Bayes</h2> -->
        </div>
    </div>
    </div>
    </div>
