...
<div class="konten"><form  method="post" name="form" target="_self" action="?top=konsulperiksa.php">
  <table class="tab" width="700" border="0" align="center" cellpadding="2" cellspacing="1" bordercolor="#FFFFFF">
    <tr> 
      <td colspan="3"><div align="center"><strong>~ FORM DIAGNOSA PENYAKIT KACANG HIJAU~</strong></div></td>
    </tr>
    <tr>
    ...
    <?php
	include "koneksi.php";
	$query=mysql_query("SELECT * FROM tbgejala ORDER BY kd_gejala ASC") or die("Query Error..!" .mysql_error);
