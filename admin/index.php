...
<table width="700" border="0" align="center">
    <tr>
      <td align="center">
                 <h1><a href="./index.html">SISTEM PAKAR DIAGNOSA PENYAKIT KACANG HIJAU</a></h1>
                 <!-- <h2>Menggunakan Metode Theorema Bayes</h2> -->
       </td>
    </tr>
    <tr>
...
<table width="251" border="0" align="center" cellpadding="3" cellspacing="0">
  ...
  <tr>
    ...
    <td><input type="submit" name="Submit" value="Login">&nbsp;&nbsp;&nbsp;&nbsp;
     <button> <a style="text-decoration:none; color:black" href="../index.php"> Kembali</a></td></button>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
